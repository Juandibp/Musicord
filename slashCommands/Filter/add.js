        ...
        try {
                ...
                return interaction.reply({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setTitle(
                                `${client.allEmojis.x} Join __my__ Voice Channel!`
                            )
            ...
            try {
                ...
                let filters = options
                    ...
                    .split(' ')
                if (!filters)
                    filters = [options.getString('filters').toLowerCase()]
                    ...
                    return interaction.reply({
                        embeds: [
                            new MessageEmbed()
                                ...
                                .setFooter(ee.footertext, ee.footericon)
                                .setTitle(
                                    `${client.allEmojis.x} **You did not add a Filter, which is not in the Filters yet.**`
                                )
                                .addField(
                ...
                interaction.reply({
                    content: `♨️ **Added ${toAdded.length} ${
                        toAdded.length == filters.length
                            ? 'Filters'
                            : `of ${filters.length} Filters! The Rest was already a part of the Filters!`
